...
public class TaskSelectorTest {
    ...
    public void givenAtExpression__whenMinuteOfHour__thenSelectableAtMinute() throws Exception {
        assertTrue("at minute", new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.minuteOfHours(32L)
                )).build()));

        assertFalse("the minute before", new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.minuteOfHours(33L)
                )).build()));

        assertFalse("the minute after", new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
    ...
    public void givenAtExpression__whenHourOfDay_andMinuteOfHour__thenSelectableAtHourMinute() throws Exception {
        ...
        assertTrue("one day before", new TaskSelector(AT_2013_04_05_10_32_42_728.minusDays(1)).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.hourOfDay(10L).minuteOfHours(32L)
                )).build()));
        ...
        assertFalse("an hours after", new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.hourOfDay(9L).minuteOfHours(32L)
                )).build()));

        assertFalse("an hours before", new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
    ...
    public void givenAtExpression__whenDayOfWeek_andHourOfDay_andMinuteOfHour__thenSelectableAtDayHourMinute() throws Exception {
        ...
        assertFalse("one day before", new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.dayOfWeek(At.DayOfWeek.SATURDAY).hourOfDay(10L).minuteOfHours(32L)
                )).build()));

        assertFalse("one day after", new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
    ...
    public void dayOfWeekComparison() throws Exception {
        for (At.DayOfWeek atdayOfWeek : At.DayOfWeek.values()) {
            ...
            assertTrue(atdayOfWeek.name(), TaskSelector.sameDayOfWeek(atdayOfWeek, javaDayOfWeek));
        }

        assertFalse(TaskSelector.sameDayOfWeek(At.DayOfWeek.MONDAY, DayOfWeek.SUNDAY));
    }
    ...
    public void givenEveryExpression__whenEvery1Minute__thenIsAlwaysSelectable() throws Exception {
        for (int i = 0; i < 500; i++) {
            int offset = i;
            assertTrue("" + i, new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
    ...
    public void givenEveryExpression__whenEvery2Minute__thenIsSelectableOneMinuteOverTwo() throws Exception {
        for (int i = 0; i < 500; i++) {
            ...
            if(i % 2 == 0) {
                ...
                assertFalse("" + i, new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                        .every(every -> every.startingAt(AT_2013_04_05_10_32_42_000.minusMinutes(offset)).minutes(2L)
                        )).build()));
            }
        }
    ...
    public void givenEveryExpression__whenEvery1Hour__thenIsSelectableOnEveryHour() throws Exception {
        assertTrue(new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .every(every -> every.startingAt(AT_2013_04_05_10_32_42_000.minusHours(1)).hours(1L)
                )).build()));
        assertFalse(new TaskSelector(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
