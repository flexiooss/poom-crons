...
public class TaskSelectorTest {
    ...
    public void givenAtExpression__whenMinuteOfHour__thenSelectableAtMinute() throws Exception {
        assertTrue("at minute", DateTimeTaskSelector.minutesPrecision(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.minuteOfHours(32L)
                )).build()));

        assertFalse("the minute before", DateTimeTaskSelector.minutesPrecision(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.minuteOfHours(33L)
                )).build()));

        assertFalse("the minute after", DateTimeTaskSelector.minutesPrecision(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
    ...
    public void givenAtExpression__whenHourOfDay_andMinuteOfHour__thenSelectableAtHourMinute() throws Exception {
        ...
        assertTrue("one day before", DateTimeTaskSelector.minutesPrecision(AT_2013_04_05_10_32_42_728.minusDays(1)).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.hourOfDay(10L).minuteOfHours(32L)
                )).build()));
        ...
        assertFalse("an hours after", DateTimeTaskSelector.minutesPrecision(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.hourOfDay(9L).minuteOfHours(32L)
                )).build()));

        assertFalse("an hours before", DateTimeTaskSelector.minutesPrecision(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
    ...
    public void givenAtExpression__whenDayOfWeek_andHourOfDay_andMinuteOfHour__thenSelectableAtDayHourMinute() throws Exception {
        ...
        assertFalse("one day before", DateTimeTaskSelector.minutesPrecision(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
                .at(at -> at.dayOfWeek(At.DayOfWeek.SATURDAY).hourOfDay(10L).minuteOfHours(32L)
                )).build()));

        assertFalse("one day after", DateTimeTaskSelector.minutesPrecision(AT_2013_04_05_10_32_42_728).selectable(TaskSpec.builder().scheduled(scheduled -> scheduled
